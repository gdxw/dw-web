...
function bootstrap_breadcrumb() {
  ...
  $html = '<div class="breadcrumb-nav"><ol class="breadcrumb">';
  
  if ( (is_front_page()) || (is_home()) ) {
    $html .= '<li class="breadcrumb-item active">首页</li>';
  }
  
  else {
    $html .= '<li class="breadcrumb-item"><a href="'.esc_url(home_url('/')).'">首页</a></li>';
    ...
    elseif ( is_search() ) {
       $html .= '<li class="breadcrumb-item active">搜索</li>';
    }
